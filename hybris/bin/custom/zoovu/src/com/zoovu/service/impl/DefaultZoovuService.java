...
public class DefaultZoovuService implements ZoovuService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultZoovuService.class);
	...
	{
		return DefaultZoovuService.class.getResourceAsStream("/zoovu/sap-hybris-platform.png");
	}
